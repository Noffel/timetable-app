...
public class EditorActivity extends AppCompatActivity {
    ...
    private void addNewSubj() {
        if (isFirstEntry)
            Log.e("First","First");
        String newSub=subject.getText().toString();
        subjects.add(newSub);
      ...
      //  Toast.makeText(getApplicationContext(),"Enter Data",Toast.LENGTH_SHORT).show();
        //TODO Make a dialog for entering  data
    }
    ...
    private boolean save(){
        ...
        String currSub = subject.getText().toString();
        ...
        if(cursor != null  && cursor.moveToFirst()){
            ...
            String subjectSt = subject.getText().toString().trim();
            String roomSt = room.getText().toString().trim();
           // String floorSt = floor.getText().toString().trim();
            //String instrucSt = instructor.getText().toString().trim();
           ...
           // String instrucSt = instructor.getText().toString().trim();
            ...
            if(subjectSt !=null && roomSt != null && !subjectSt.equals("")&&!roomSt.equals("")&&
                    !subjectSt.contains("null")&&!roomSt.contains("null") ) {
                values.put(sqlArray[selectedPos], subject.getText().toString() + "-" + room.getText().toString());
